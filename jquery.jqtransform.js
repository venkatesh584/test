...
(function ($) {
  ...
  var jqTransformHideSelect = function (oTarget) {
    ...
    ulVisible.each(function () {
      ...
      if (
        !(oTarget && oSelect.oLabel && oSelect.oLabel.get(0) == oTarget.get(0))
      ) {
        $(this).hide();
      }
    });
  ...
  $.fn.jqTransRadio = function () {
    return this.each(function () {
      ...
      var aLink = $(
        '<a href="#" class="jqTransformRadio" rel="' + this.name + '"></a>'
      );
      $input
        .addClass("jqTransformHidden")
  ...
  $.fn.jqTransTextarea = function () {
    return this.each(function () {
      ...
      strTable +=
        '<tr><td id="jqTransformTextarea-tl"></td><td id="jqTransformTextarea-tm"></td><td id="jqTransformTextarea-tr"></td></tr>';
      strTable +=
        '<tr><td id="jqTransformTextarea-ml">&nbsp;</td><td id="jqTransformTextarea-mm"><div></div></td><td id="jqTransformTextarea-mr">&nbsp;</td></tr>';
      strTable +=
        '<tr><td id="jqTransformTextarea-bl"></td><td id="jqTransformTextarea-bm"></td><td id="jqTransformTextarea-br"></td></tr>';
      strTable += "</table>";
      var oTable = $(strTable)
  ...
  $.fn.jqTransSelect = function () {
    return this.each(function (index) {
      ...
      $wrapper.prepend(
        '<div><span></span><a href="#" class="jqTransformSelectOpen"></a></div><ul></ul>'
      );
      ...
      var newWidth =
        iSelectWidth > oSpan.innerWidth()
          ? iSelectWidth + oLinkOpen.outerWidth()
          : $wrapper.width();
